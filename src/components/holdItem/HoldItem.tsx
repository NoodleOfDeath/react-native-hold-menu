...
const HoldItemComponent = ({
  ...
  const { dimensionWidth, dimensionHeight } = useStyleGuide();
  ...
  const isHold = useMemo(() => !activateOn || activateOn === 'hold', [activateOn]);
  //#endregion
  ...
  const activateAnimation = useCallback((ctx: any) => {
    'worklet';
